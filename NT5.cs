    ...
    public partial class NT5 : Form
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String sql = "INSERT INTO equipment (name,amount,price) VALUES('NOTEBOOK ACER NITRO 5 AN515-55-77UK','" + comboBox1.Text + "','37900')";
                //"UPDATE users SET name ='NOTEBOOK ACER NITRO 5 AN515-55-77UK',amount= '" + comboBox1.Text + "',price='37900' WHERE id = '" + Program.username + "'";

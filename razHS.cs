...
namespace JIB.spino
{
    public partial class razHS : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String sql = "INSERT INTO equipment (name,amount,price) VALUES('Razer Kraken Tournament Edition','" + comboBox2.Text + "','3490')";
                //"UPDATE users SET name ='Razer Kraken Tournament Edition',amount= '" + comboBox2.Text + "',price='3490' WHERE id = '" + Program.username + "'";
